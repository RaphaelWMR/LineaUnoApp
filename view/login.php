    ...
    <div class="login m-3">
        <div>
            <form action="./dashboard/dashboard.php">
                ...
                <p class="mb-3 pb-lg-2" style="color: #393f81;">¿Aún no tienes una cuenta? <a href="./signUp/SignUp.php" style="color: #393f81;">Regístrate</a></p>
                <a href="./signIn/useTerms.php" class="small text-muted" target="_blank">Términos de uso</a>
